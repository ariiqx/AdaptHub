...
public class SlidesFragment extends DialogFragment {
    private String TAG = SlidesFragment.class.getSimpleName();
    ...
    static SlidesFragment newInstance() {
        SlidesFragment f = new SlidesFragment();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        photoList = (ArrayList<Photo>) getArguments().getSerializable("images");
        selectedPosition = getArguments().getInt("position");

        Log.e(TAG, "position: " + selectedPosition);
        Log.e(TAG, "images size: " + photoList.size());
    ...
    private void displayMetaInfo(int position) {
        lblCount.setText((position + 1) + " of " + photoList.size());

        Photo photo = photoList.get(position);
        lblTitle.setText(photo.getCaption());
        lblDate.setText(photo.getCreated());
    }
